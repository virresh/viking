...
def perturbation_top_flips(adj_matrix, candidates, n_flips, dim, window_size, L=None, mode='supervised'):
...
def estimate_loss_with_supervision_type2(candidates, flip_indicator, A, L, n_nodes):
    """
    Compute community loss for every candidate flip
